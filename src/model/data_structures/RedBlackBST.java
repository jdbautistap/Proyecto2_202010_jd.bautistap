...
public class RedBlackBST<K extends Comparable<K>, V>
{
	...
	public int darAlt(K llave){
		int res = -1;
		if(root != null){
			res = root.darAltura(llave);
		}
		return res;
	}
	...
	public Iterable<K> keys() {
		if (isEmpty()) return  (Iterable<K>) new Cola<K>();
		return keys(min(), max());
	}
