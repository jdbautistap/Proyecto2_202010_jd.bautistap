...
public class MaxColaPrioridadCommparendo2 
{
	/**
	 ...
	 * Constructor
	 */
	public MaxColaPrioridadCommparendo2 ()
	{
		head=null;
		Contador=0;
	}
	...
	public void agregar(Commparendo elemento)
	{
		...
		else
		{
			...
			if(head == null)
			{
				...
				{
					if(head.darElem().compareTo2C(elemento) > 0)
					{
				...
				else
				{
					...
					while(!add){
						if(actual.darElem().compareTo2C(elemento) > 0){
